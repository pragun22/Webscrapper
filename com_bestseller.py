...
def spider(max_pages):
    ...
    while page <= max_pages:
        ...
        url = 'https://www.amazon.com/best-sellers-books-Amazon/zgbs/books/ref=zg_bs_pg_'
        url += str(page)+'/144-1025164-5395322?_encoding=UTF8&pg='+str(page)
        ...
        for link in soup.findAll('div', {'class': 'zg_itemImmersion'}):
            href = link.find('a')
            if(link.find('a')):
                book_link = 'https://www.amazon.com'+href.get('href')
            else:
